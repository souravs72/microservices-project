...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeAdminUser() {
        ...
        if (userRepository.existsByUsername(adminUsername)) {
            log.info("Admin user profile '{}' already exists in user service, skipping initialization", adminUsername);
            return;
        }
        ...
        try {
            ...
            throw new RuntimeException("Failed to initialize admin user profile", e);
        }
    }
}
